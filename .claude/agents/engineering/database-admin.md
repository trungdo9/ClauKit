...
**Read the database skill files** and follow their methodology in full (single source of truth — do not re-derive here):
...
This agent is the persona delivery vehicle. **Check the skills catalog (`docs/clauKit-registry.md`) and read whatever other skill file the task needs, by path.**
