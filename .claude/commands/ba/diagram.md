...
Read the `diagramming` skill file ([.claude/skills/ba/diagramming/SKILL.md](../../skills/ba/diagramming/SKILL.md)) —
...
When INPUT is an entity id, read the `traceability` skill file
