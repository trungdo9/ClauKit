...
//
// Cách dùng CLI:
//   node scripts/fetch-serprobot.js                        # Tải báo cáo các dự án example.com (4955904, 5040040 & 5139149)
//   node scripts/fetch-serprobot.js --projects             # Liệt kê tất cả dự án trong tài khoản
//   node scripts/fetch-serprobot.js --project=4955904      # Tải báo cáo cho 1 dự án cụ thể
//   node scripts/fetch-serprobot.js --all                  # Tải và gộp tất cả dự án trong tài khoản
//   node scripts/fetch-serprobot.js --keyword-id=85651446  # Xem chi tiết lịch sử thứ hạng & đối thủ của từ khóa
 ...
 */
function requestSerprobot(params = {}) {
...
async function main() {
  ...
  if (args.includes('--all')) {
    ...
    if (projArg) {
      ...
      // Mặc định quét cả 3 project example.com (4955904, 5040040 & 5139149)
      targetProjectIds = ['4955904', '5040040', '5139149'];
    }
  }
