...
([.claude/skills/software/scenario/SKILL.md](../../software/scenario/SKILL.md)) —
...
- **Read the `ba-traceability` skill file** ([.claude/skills/ba/traceability/SKILL.md](../traceability/SKILL.md)) — the id scheme, entity contract, and `validate`/`index` CLI this skill's actions call before and after writing.
- **Read the `scenario` skill file** ([.claude/skills/software/scenario/SKILL.md](../../software/scenario/SKILL.md)) — the design method `tc` reuses instead of restating.
