...
1. **Search Strategy**:
   - Use the `WebSearch` tool for web research; save findings to `./plans/<plan-name>/reports/YYMMDD-<your-research-topic>.md` (including all citations).
   - Run multiple `WebSearch` calls in parallel to cover relevant angles.
